                ...
                <div class="content col-xs-12">
                    <div class="col-xs-12 col-md-8">
                            ...
                            <form role="form"  name="reg_form"  id="form" class="form-vertical" action="" enctype="multipart/form-data" method="POST">
                                <h4>ADD NEW GENERAL NOTICE</h4>
                                <?php echo $notice_msg; ?>
                                <hr/>
                                <div class="form-group">
                                    <label for="txttitle">Notice Title: </label>
                                    <textarea rows="4" colunms="12" class="form-control" id="txttitle" name="txttitle" required="true" placeholder="Enter Notice Title"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="txtdescription">Notice Description: </label>
                                    <textarea rows="11" colunms="25" class="form-control"  id="txtdescription" name="txtdescription" required="true" placeholder="Enter Notice Description"></textarea>
                                    
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="proceed" style="width:100%" value="CREATE NOTICE" class="btn btn-primary btn-md"></input>
                                </div>
                            </form>
                    </div>
